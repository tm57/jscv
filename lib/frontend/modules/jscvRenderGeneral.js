function jscvRenderGeneral(){
    ...
    this.makeSubSection = function(sectionContentSingle, textHeight){
        var firstLine = sectionContentSingle.startDate + " - " + sectionContentSingle.endDate;
        var detail = sectionContentSingle.sectionDetailedDescription;
        this.addSectionHeading(textHeight, firstLine, this.subSectionFontSize, this.subsectionFont, this.subSectionFontType);
        this.addSectionHeading(textHeight, sectionContentSingle.sectionTitle, this.subSectionFontSize, this.subsectionFont, this.subSectionFontType, this.marginMid);
